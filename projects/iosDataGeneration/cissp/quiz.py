    ...
    with open (os.path.join(file_directory_name, "swedish_sign_board.csv"), "r") as f:
        ...
        if header != None:
            for rows in csv_reader:
                data.append("level.append(QuizData(category: \"{}\", question: \"{}\", choiceA: \"{}\", choiceB: \"{}\", choiceC: \"{}\", choiceD: \"{}\", explanation: \"{}\", answer: {}))".format(rows[0],rows[1],rows[2],rows[3],rows[4],rows[5],rows[6],rows[7]))
