# Python program to find maximum XOR subset
...
input_list = list(map(int, open("sample.in", "r").readlines()[1].split()))
#print("inputlist: ", input_list, len(input_list))
print(maxSubarrayXOR(input_list, len(input_list)))